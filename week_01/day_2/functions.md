...
A function has it's own internal world and doesn't share the variables that another function has. We call this little world the _scope_ of the function.
